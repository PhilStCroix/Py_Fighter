...
class Fighter:
    def __init__(self, player, x, y, flip, data, sprite_sheet, animation_steps, sound):
        ...
        self.action = 0  # 1:run 2:jump 3:attack1 4:attack2 5:hit 6:death
        self.frame_index = 0
    ...
    def move(self, swidth, sheight, surface, target, round_over):
        SPEED = 10
        GRAVITY = 2
        dx = 0
        dy = 0
        ...
        if self.rect.bottom + dy > sheight - 110:
            self.vel_y = 0
            self.jump = False
            dy = sheight - 110 - self.rect.bottom

        # check fighter facing car
